<template>
  <div class="flex flex-col h-full px-12 py-8">
    <div class="mb-6">
      <h2 class="text-3xl font-bold" :class="textClass">🔭 Visie</h2>
      <p class="text-sm mt-1" :class="subtextClass">Waar staat het bedrijf voor? Wat is het toekomstbeeld?</p>
    </div>
    <div class="flex-1">
      <textarea
        :value="sessie.visie"
        ...
        :class="inputBgClass"
        placeholder="Beschrijf hier de visie van het bedrijf..."
      ></textarea>
    </div>
  </div>
</template>
